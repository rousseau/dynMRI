...
if __name__ == '__main__':
  ...
  parser.add_argument('-in', '--inputNifti', help='Input nifti texture', type=str, required=False, default = '/home/benjamin/Documents/DataYue/score_deformation_edge_all.nii')
  parser.add_argument('-o', '--output', help='Output mesh', type=str, required=False, default = 'deformation_no_color.vtk')
