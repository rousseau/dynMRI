...
if __name__ == '__main__':
    ...
    if data != 'MNIST':
        if args.dynamic_path!=None and args.static_path!=None:
            assert (args.data == 'custom' or args.data == 'custom_simulate'), "If you are specifying paths for Equinus images, set the 'data' option to 'custom' or 'custom_simulate'"
            subjects, check_subjects = load_data(data=data, segmentation=args.segmentation, batch_size=training_batch_size, dynamic_path = args.dynamic_path, static_path = args.static_path, seg_path=args.seg_path, footmask_path=args.footmask_path)
        else:
        ...
        if (data=="equinus_256" or data=="bone_segmentation_equinus_256" or data=="segmentation_equinus_256" or data=='equinus_256_boneseg' or data=='custom'):
            ...
            test_sub=['sub_E03']
        elif data=="simulate_256" or data=='custom_simulate':
            training_sub=['sub_E09', 'sub_E05', 'sub_T03', 'sub_T02', 'sub_E08', 'sub_E13', 'sub_T05', 'sub_E10', 'sub_T01', 'sub_T07', 'sub_T04', 'sub_E02', 'sub_E06', 'sub_E01', 'sub_T08', 'sub_T09']
            validation_sub=['sub_T06']
            test_sub=['sub_E03']
